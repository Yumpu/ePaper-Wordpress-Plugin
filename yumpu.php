     ...
     */
 	public function admin_notice() {
        ...
        if (empty($api_token) || is_null($api_token)) {
            echo '<div class="updated"><p>Add your Yumpu.com API Key, get it for free at <a target="_blank" href="http://yumpu.com">Yumpu.com</a>  or Create your free account from <a href="./options-general.php?page=yumpu-settings">here</a></p></div>';
        }
    }
