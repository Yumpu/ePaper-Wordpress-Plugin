        ...
        <div id="media-frame-tab1" class="yumpu_tab">
            ...
            <div class="yumpu_uploader">
                <div class="intro">
                    ...
                    <p>
                        <small>Upload max filesize: <?php echo $this->upload_max_filesize; ?>.</small>
                    </p>
                </div>
                <div class="media-sidebar">
                    <div class="attachment-details">
                        <form method="post" target="ifmUpload"
                              action="/wp-admin/admin-ajax.php?action=wp_yumpu&run=editorActions&method=upload"
                              enctype="multipart/form-data">
                            <input type="file" id="uploadButton" name="Filedata" class="uploadButton"
                                   style="display:none">
                            <h3>Optional</h3>
                            <label class="setting" data-setting="title">
                                <span>Document Title</span>
                                <input type="text" id="yumpu_document_title" value=""
                                       placeholder="Enter document title..." name="title">
                    ...
                    <tr class="<?php echo (++$count % 2) ? "" : "alternate"; ?>">
                        ...
                        <td>
                            <button class="yp-insert-short-code" id="<?php echo ($ePaper->getEpaper_id());?>"
                                    ...
                                    type="button" <?php echo ($ePaper->getEpaper_id()) ? '' : 'disabled' ?>> Insert
                                Shortcode
                            </button>
                        </td>
                    </tr>
    ...
    <div class="media-frame-toolbar">
        <div class="media-toolbar">
            ...
            <div class="media-toolbar-primary">
                ...
                <a id="yumpu_uploadButton" href="javascript:;"
                   class="button media-button button-primary button-large media-button-insert" disabled="disabled">
...
<script>
    ...
    $(document).ready(function () {
        $('.yp-insert-short-code').on('click', function () {
            id=this.id;
            yumpuAddShortcode(id, 512, 384);
        });
    });
</script>
</body>
